...
wkv_cuda = load(name="wkv", sources=["/home/diandian/Diandian/DD/basicsr/basicsr/cuda/wkv_op.cpp", "/home/diandian/Diandian/DD/basicsr/basicsr/cuda/wkv_cuda.cu"],
...
class restorerwkv(nn.Module):
    def __init__(self,
        ...
        super(restorerwkv, self).__init__()
